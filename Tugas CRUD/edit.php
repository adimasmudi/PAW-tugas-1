<?php
    ...
    try{
        $id = $_GET['id'];
        $data = $db->query("SELECT * FROM tbl_160 WHERE id=$id")->fetch(PDO::FETCH_ASSOC);
    }catch(Exception $e){
        echo '';
    }
    ...
    if(isset($_POST["edit"])){
        ...
        $sql = "UPDATE tbl_160 set Nama=:nama, Tanggal=:tanggal, Jenis=:jenis, Nominal=:nominal, Catatan=:catatan WHERE id=$edit_id";
        ...
        <div id="auth-left">
            ...
            <form action="edit.php" method="POST">
                ...
                <div class="form-group position-relative has-icon-left mb-4">
                    <input type="text" class="form-control form-control-xl" placeholder="Nama" name="Nama" value="<?php echo $data["Nama"]; ?>">

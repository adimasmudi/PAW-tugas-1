...
$pengguna = $_SESSION["user"]["ID_pengguna"];


$catatan = $db->query("SELECT * FROM catatan WHERE ID_pengguna='$pengguna'");
            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header">
                    <div class="d-flex justify-content-between">
                        <div class="logo">
                            <h1 class="active">Catat Uang</h1>
                            <span class="active"><?php echo $pengguna; ?></span>
                        </div>
                        <div class="toggler">
                    ...
                    <div class="col-12">
                        <div class="card catatan-table">
                            <div class="card-header">
                                ...
                                <a href="tambah.php?user=<?php echo $pengguna; ?>" class="btn btn-primary">Tambah</a>
                            </div>
                            <div class="card-content">
                                ...
                                <div class="table-responsive">
                                    ...
                                    $data_pagination = $db->query("SELECT * FROM catatan WHERE ID_pengguna='$pengguna' LIMIT $page_first_result,$results_per_page");
                                    ...
                                    <nav aria-label="Page navigation example" class="mt-3">
                                        <ul class="pagination pagination-primary  justify-content-center">
                                            ...
                                            ?>
                                                ...
                                                <li class="page-item <?php echo $page == $i ? "active" : "" ?>"><a class="page-link" href="?page=<?= $i ?>"><?php echo $i; ?></a></li>
                                            <?php
                                            }
